<template>
    <footer class="pt-5 text-light bg-dark">
        ...
        <div class="text-center">
            ...
            <img src="../assets/facebook.svg" alt="facebook" height="40">
            </a>
            <a class="px-2" href="https://twitter.com">
            <img src="../assets/google.svg" alt="google" height="50">
            </a>
            <a class="px-2" href="https://instagram.com">
            <img src="../assets/twitter.svg" alt="twitter" height="40">
            </a>
            <a class="px-2" href="https://pinterest.com">
            <img src="../assets/viber.svg" alt="viber" height="40">
            </a>
        </div>
        </div>
